...
public class ExternalTaskHandlerDecorator implements ExternalTaskHandler {
    ...
    public static com.bank.bpm.partners.workers.onboarding.component.ExternalTaskHandlerDecorator from(final ExternalTaskHandler handler,
            final ExternalTaskSettings settings) {
    ...
    public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
        try {
            ...
            externalTaskService.handleFailure(externalTask, GENERIC_FAILURE, e.getMessage(), decrementRetries(externalTask), calculateBackoff(externalTask));
        }
    }
